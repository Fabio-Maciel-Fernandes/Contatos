...
namespace Contatos.Test.Infra.Services
{
    ...
    {
        private readonly Mock<IRepository<Regiao>> _repositoryMock;
        private readonly Mock<ICacheService> _cacheServiceMock;
        private readonly RegiaoServices _regiaoServices;

        public RegiaoServicesTests()
        {
            _repositoryMock = new Mock<IRepository<Regiao>>();
            _cacheServiceMock = new Mock<ICacheService>();
            _regiaoServices = new RegiaoServices(_repositoryMock.Object, _cacheServiceMock.Object);
        }
